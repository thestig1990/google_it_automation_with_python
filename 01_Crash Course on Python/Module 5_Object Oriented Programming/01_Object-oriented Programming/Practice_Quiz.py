...
# 2. print(bluejay.number.count())
# 3. bluejay.count()
# 4. print(bluejay.number)
#    rint(bluejay.number)
...
# its country (separated by a comma), when comparing the 3 defined instances for a specified
# minimal population. For example, calling the function for a minimum population of 1 million:
