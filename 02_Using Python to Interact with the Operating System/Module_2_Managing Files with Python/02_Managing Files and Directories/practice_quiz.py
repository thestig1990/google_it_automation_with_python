...
# adds the line of comments to it declared by the 'comments' variable, and returns the size
...
def file_date(filename):
  ...
  timestamp_readable = datetime.datetime.fromtimestamp(timestamp)
  # Return just the date portion 
  # Hint: how many characters are in “yyyy-mm-dd”? 
  return ("{}".format(timestamp_readable.strftime("%Y-%m-%d")))
...
# just above the current working directory. Remember that '..' is a relative path alias
