...
# to process the data without turning it into a dictionary. How do you skip over the
# header record with the field names?
...
# 1.Create an instance of the DictWriter() class - RIGHT!
# 2.Write the fieldnames parameter into the first row using writeheader() - RIGHT!
# 3.Open the csv file using with open - RIGHT!
# 4.Import the OS module - WRONG!
...
# 1.We need the same amount of variables as there are columns of data in the CSV - RIGHT!
# 2.Rows can be read using both csv.reader and csv.DictReader - RIGHT!
# 3.An instance of the reader class must be created first - RIGHT!
# 4. The CSV file does not have to be explicitly opened - WRONG!
